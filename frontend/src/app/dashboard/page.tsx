    ...
    <div className="h-screen flex flex-col bg-gradient-to-br from-teal-200 via-blue-400 to-indigo-700 text-white font-sans">
      ...
      <main className="flex flex-1 w-full">
        ...
        <section className="flex-1 p-6 max-w-full">
          <h1 className="text-4xl font-extrabold drop-shadow-2xl ml-10 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
            {recordings.map((recording) => {
              return (
                <div key={recording.id} className="bg-white/10 backdrop-blur-sm rounded-lg p-6 shadow-lg">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-indigo-300">@{recording.sender.username}</p>
                    </div>
                  </div>
                  <audio 
                    controls 
