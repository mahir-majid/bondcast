...
interface FancyDashboardRecordingProps {
  recordingId?: number;
  audioSrc?: string;
  sender?: {
    firstname: string;
...
export default function FancyDashboardRecording({ recordingId, audioSrc, sender, title, showSender = false, className = '', onPlay }: FancyDashboardRecordingProps) {
